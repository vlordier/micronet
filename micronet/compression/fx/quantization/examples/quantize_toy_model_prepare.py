...
from micronet.compression.fx.quantization.configs import (
...
# ptq_quantizer = Quantizer(qconfig=default_static_qconfig)
ptq_quantizer = Quantizer(qconfig=default_static_qconfig, debug=True)
...
# qat_quantizer = Quantizer(qconfig=default_qat_qconfig)
qat_quantizer = Quantizer(qconfig=default_qat_qconfig, debug=True)
